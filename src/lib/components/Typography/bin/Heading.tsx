...
export const H1 = styled.h1<Props>`
  ...
  line-height: ${({ lineHeight, theme }) => lineHeight || `${Math.floor(theme.fonts.size.title * 1.25)}px` };
...
export const H3 = styled.h3<Props>`
  ...
  line-height: ${({ lineHeight, theme }) => lineHeight || `${Math.floor(theme.fonts.size.large * 1.25)}px` };
  font-weight: ${({ weight, theme }) => weight ||  theme.fonts.weight.normal };
  font-style: italic; 
`
...
export const H5 = styled.h5<Props>`
  ...
  line-height: ${({ lineHeight, theme }) => lineHeight || `${Math.floor(theme.fonts.size.normal * 1.25)}px` }; ;
...
export const H6 = styled.h6<Props>`
  ...
  line-height: ${({ lineHeight, theme }) => lineHeight || `${Math.floor(theme.fonts.size.small * 1.25)}px` }; ;
  font-weight: ${({ weight, theme }) => weight ||  theme.fonts.weight.light }; 
`; 