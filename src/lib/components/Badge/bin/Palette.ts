...
export const getBadgePallete = (theme: Theme): BadgePalette => ({
  primary: {
    background: theme.palette.accent.shades[4],
    text: theme.palette.black,
    border: theme.palette.accent.shades[4],
    icon: theme.palette.black,
  },
  accent: {
    background: theme.palette.accent.shades[2],
    text: theme.palette.black,
    border: theme.palette.accent.shades[2],
    icon: theme.palette.black,
  },
  success: {
    background: theme.palette.success.shades[2],
    text: theme.palette.success.shades[0],
    border: theme.palette.success.shades[2],
    icon: theme.palette.success.shades[0],
  },
  warning: {
    background: theme.palette.warning.shades[2],
    text: theme.palette.warning.shades[0],
    border: theme.palette.warning.shades[2],
    icon: theme.palette.warning.shades[0],
  },
  danger: {
    background: theme.palette.danger.shades[2],
    text: theme.palette.danger.shades[0],
    border: theme.palette.danger.shades[2],
    icon: theme.palette.danger.shades[0],
  },
  grey: {
