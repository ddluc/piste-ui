...
const Select = forwardRef<HTMLSelectElement, Props>((props: Props, ref): JSX.Element => {
  ...
  const renderPlaceholder = () => {
    if (placeholder) return <DisabledOption value="default" disabled>{placeholder}</DisabledOption>;
    return <DisabledOption value="default" disabled>{label}</DisabledOption>;
  };
